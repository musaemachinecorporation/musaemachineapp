...
public class GraphicRender{
	 ...
	 */
	public void renderWaveform(Wave wave) {
		renderWaveform(wave,WAVEFORM_DEFAULT_TIMESTEP,width,height);
	}
	
	
	public void renderWaveform(Wave wave, float timeStep){
		renderWaveform(wave,timeStep,width,height);
	}
	 ...
	 * @see	RGB graphic rendered
	 */
	public BufferedImage renderWaveform(Wave wave, float timeStep,int width,int height) {
		this.width=width;
		 this.height=height;
