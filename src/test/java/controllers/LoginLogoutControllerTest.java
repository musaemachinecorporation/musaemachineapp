...
public class LoginLogoutControllerTest extends NinjaTest {
    ...
    public void testLoginLogout() {
        ...
        // /////////////////////////////////////////////////////////////////////
        // Test uploading of audio does not work without login
        // /////////////////////////////////////////////////////////////////////
        ...
        // /////////////////////////////////////////////////////////////////////
        // Test uploading of audio works when are logged in
        // /////////////////////////////////////////////////////////////////////
        response = ninjaTestBrowser.makeRequest(getServerAddress()
                + "audio/new", headers);
        
        assertTrue(response.contains("New audio"));
        ...
        // /////////////////////////////////////////////////////////////////////
        // Assert that uploading of audio does not work any more...
        // /////////////////////////////////////////////////////////////////////
        response = ninjaTestBrowser.makeRequest(getServerAddress()
                + "audio/new", headers);
        System.out.println(response);
